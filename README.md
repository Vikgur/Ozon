...
Этот проект представляет собой рабочие образцы 54 автоматизированных UI и API тестов с применением ООП в браузере Google Chrome из тестовых наборов, таблиц состояний/переходов, матриц трассировки и тест-сессий сайтов www.ozon.ru  и www.ozon.ru/travel. 
...
В качестве системы тест-менеджмента и баг-трекинга мною выбрана платформа QASE https://qase.io/

Демо оформления моего проекта в QASE на Youtube: https://youtu.be/tzbQx5w7iiw

В качестве системы отчетов мною выбран инструмент Allure.
