...
1. [Тестовые наборы Ozon и Ozon Travel](#тестовые-наборы-ozon-и-ozon-travel)  
    1. [Тестовый набор «tests» Ozon](#1-тестовый-набор-tests-httpswwwozonru)         
        ...
        1. [Тестирование выпадающих списков элементов](#5-тестирование-выпадающих-списков-элементов)
...
Этот проект представляет собой рабочие образцы 50 автоматизированных тестов с применением ООП в браузере Google Chrome из тестовых наборов, таблиц состояний/переходов, матриц трассировки и тест-сессий сайтов www.ozon.ru  и www.ozon.ru/travel. 
...
Общее время выполнения всех 50 автотестов с отчетом: 9 мин 10 сек.
...
6. [Отчет о всех проведенных в проекте автотестах].
...
#### 5. Тестирование выпадающих списков элементов 
...
Цель: проверка пункта 2 чек-листа 13.3.
...
Цель: проверка пункта 3 чек-листа 13.4.
...
Шаги для воспроизведения: тест-кейсы 13.4 Тестирование кнопки «Не могу войти» и 13.6.2 Тестирование кнопки «Не могу войти».

Ожидаемый результат: наличие кнопки «Вернуться на главный экран», которая возвращает на окно авторизации по номеру телефона.

Ожидаемый результат: кнопка «Вернуться на главный экран» отсутствует.
￼
