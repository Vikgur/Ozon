...
Этот проект представляет собой рабочие образцы 54 UI автоматизированных тестов с применением ООП в браузере Google Chrome из тестовых наборов, таблиц состояний/переходов, матриц трассировки и тест-сессий сайтов www.ozon.ru  и www.ozon.ru/travel. 
